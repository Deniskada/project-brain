...
- [docs/README.md](README.md) — обзор и структура документации
- [docs/STATUS.md](STATUS.md) — актуальный прогресс по фазам
- [docs/USAGE.md](USAGE.md) — операционные команды и сценарии
- [docs/GITHUB_AUTO_UPDATE_GUIDE.md](GITHUB_AUTO_UPDATE_GUIDE.md) — настройка автоиндексации

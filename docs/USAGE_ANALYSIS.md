...
#### 6. GitHub автообновление ✅ РЕАЛИЗОВАНО
- ✅ Webhook при push
- ✅ Автоматическая переиндексация
- ✅ Статус индексации через API
- 📖 **Инструкция:** `docs/GITHUB_AUTO_UPDATE_GUIDE.md`

**Что работает:**
- Webhook endpoint: `/api/webhook/github`
- Статус API: `/api/webhook/status`
- Ручная индексация: `/api/webhook/manual-reindex/{project}`
- Защита HMAC-SHA256 секретом

**Настройка (5 минут):**
1. Добавить webhook в GitHub → Settings → Webhooks
2. URL: `http://192.168.2.107:8003/api/webhook/github`
3. Secret: `f00872ab2116aa77a1931cbaa594cf3bf77b63ecf9a7739955366511fb14f42e`
4. Готово! При push → автоматическая индексация
